...
public class NRDFS extends x10.core.Ref implements x10.serialization.X10JavaSerializable
{
    ...
    //#line 46 "F:/GitHub/x10_tutorial/tree_search/src/tree_search/NRDFS.x10"
    public double x;
    
    //#line 47 "F:/GitHub/x10_tutorial/tree_search/src/tree_search/NRDFS.x10"
    public double y;
    
    
    //#line 48 "F:/GitHub/x10_tutorial/tree_search/src/tree_search/NRDFS.x10"
    ...
    final public tree_search.NRDFS tree_search$NRDFS$$init$S(final double x, final double y) {
         {
            ...
            //#line 45 "F:/GitHub/x10_tutorial/tree_search/src/tree_search/NRDFS.x10"
            this.__fieldInitializers_tree_search_NRDFS();
            
            //#line 49 "F:/GitHub/x10_tutorial/tree_search/src/tree_search/NRDFS.x10"
            this.x = x;
    ...
    //#line 52 "F:/GitHub/x10_tutorial/tree_search/src/tree_search/NRDFS.x10"
    public double magnitude$O() {
        
        //#line 52 "F:/GitHub/x10_tutorial/tree_search/src/tree_search/NRDFS.x10"
        final double t$397 = this.x;
        
        //#line 52 "F:/GitHub/x10_tutorial/tree_search/src/tree_search/NRDFS.x10"
        final double t$398 = this.x;
        
        //#line 52 "F:/GitHub/x10_tutorial/tree_search/src/tree_search/NRDFS.x10"
        final double t$401 = ((t$397) * (((double)(t$398))));
        
        //#line 52 "F:/GitHub/x10_tutorial/tree_search/src/tree_search/NRDFS.x10"
        final double t$399 = this.y;
        
        //#line 52 "F:/GitHub/x10_tutorial/tree_search/src/tree_search/NRDFS.x10"
        final double t$400 = this.y;
        
        //#line 52 "F:/GitHub/x10_tutorial/tree_search/src/tree_search/NRDFS.x10"
        final double t$402 = ((t$399) * (((double)(t$400))));
        
        //#line 52 "F:/GitHub/x10_tutorial/tree_search/src/tree_search/NRDFS.x10"
        final double t$403 = ((t$401) + (((double)(t$402))));
